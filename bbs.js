...
const FILES = {
  ...
  "MITNICK.NFO": [
    ...
    "==========",
    "",
    "STATUS AS OF THIS POSTING: in custody. Seven months so far.",
    "",
    "Arrested 15 February 1995 in Raleigh, North Carolina. He has",
    "not had a bail hearing. He is not going to get one for a very",
    "long time, and he will sit in custody for something close to",
    "five years before anybody gets around to sentencing him. Some",
    "of that will be spent in solitary.",
    "",
    "The court was told, and this is not an embellishment, that he",
    "could start a nuclear war by whistling into a telephone.",
    "",
    "What he actually did was copy source code he had no use for",
    "and never sold. The loss figures in the papers grew every time",
    "a reporter asked for one, and nobody was ever made to show",
    "their working.",
    "",
    "THE STICKERS: you have seen them. Three words, on the back of",
    "every laptop and half the road signs at every gathering for",
    "years. A magazine ran the campaign and it did not let go.",
    "",
    "NOTE FOR THE FILE: this board took that format, changed one",
    "word, and pointed it at a kid nobody is ever going to write a",
    "book about. That is not a coincidence and it is not entirely a",
    "joke.",
    "",
    "SYSOP NOTE, ADDED LATER: he was released in January 2000. He",
    "spent the rest of his working life doing security for the kind",
    "of companies that had once wanted him buried, which is its own",
    "kind of ending. He died in 2023.",
  ],
  "POULSEN.NFO": [
    "DARK DANTE",
    "==========",
    "",
    "A Los Angeles radio station ran a competition. The hundred and",
    "second caller won a Porsche.",
    "",
    "In 1990 Kevin Poulsen took control of the station's telephone",
    "lines and arranged for himself to be the hundred and second",
    "caller. He won the Porsche. He did this more than once and",
    "with more than one prize.",
    "",
    "It is the funniest computer crime of the decade and it was not",
    "what they wanted him for. He had also been into federal wiretap",
    "records, which is a different order of problem entirely.",
    "",
    "While he was a fugitive, a television programme about unsolved",
    "cases ran a segment on him. The story goes that the show's",
    "telephone tip lines stopped working during the broadcast.",
    "Nobody has ever proven that was him.",
    "",
    "Arrested 1991 in a supermarket. Fifty one months, which was",
    "the longest anybody had been given for this at the time.",
    "",
    "SYSOP NOTE, ADDED LATER: he came out, became a journalist, and",
    "spent decades writing about the subject from the other side of",
    "it. He is one of the very few people in this directory whose",
    "second act was better than the first.",
  ],
  "PGP.NFO": [
    "THE PROGRAM THAT WAS A MUNITION",
    "===============================",
    "",
    "In 1991 Phil Zimmermann wrote a program that let ordinary",
    "people encrypt their own mail, and gave it away. It went",
    "around the world in weeks, because that is what the network",
    "is for.",
    "",
    "The United States government classified strong cryptography",
    "as munitions. Exporting it was therefore the same category of",
    "act as exporting a weapon. Zimmermann had not exported",
    "anything. He had put a file somewhere and other people had",
    "moved it.",
    "",
    "He was under federal criminal investigation for three years.",
    "",
    "What he did about it: he had the source code printed as a",
    "book. Books are speech, speech is protected, and a printed",
    "book can be carried out of the country by anybody who wants",
    "to. Somebody on the other end could type it back in.",
    "",
    "The investigation was dropped in 1996 without charges.",
    "",
    "NOTE FOR THE FILE: three years of a man's life, over a file.",
    "He wrote his. The subject of this case did not write his and",
    "could not read it.",
  ],
  "LEVIN.NFO": [
    "TEN MILLION DOLLARS",
    "===================",
    "",
    "1994. Somebody in St Petersburg got into Citibank's cash",
    "management system and moved something like ten and a half",
    "million dollars out of it, in pieces, to accounts in several",
    "countries.",
    "",
    "Almost all of it came back. A few hundred thousand did not.",
    "",
    "Vladimir Levin was arrested in London in 1995 and eventually",
    "sent to the United States, where he pleaded guilty. Later",
    "accounts suggest he bought the access from somebody else",
    "rather than finding it himself, which if true makes him the",
    "customer rather than the hacker.",
    "",
    "NOTE FOR THE FILE: this is the case everybody points at when",
    "they want to explain why a teenager with a modem is a threat",
    "to the banking system. Read the amount again, then read the",
    "ledger in the garbage file. One of these was done by a person",
  ...
  "2600.NFO": [
    ...
    "=============",
    "",
    "A quarterly, started in 1984, named after the tone. See",
    "BLUEBOX.NFO, and then type 2600.",
    "",
    "It prints what other publications will not: payphone",
    "photographs from around the world, letters from prison,",
    "technical detail nobody else considers printable, and a",
    "standing argument that curiosity is not a crime.",
    "",
    "The editor writes under a name borrowed from Orwell. There is",
    "a radio show on New York public radio, weekly, since 1988.",
    "",
    "THE MEETINGS: first Friday of the month, five o'clock local",
    "time, in a public place, in whatever city you are in. Payphone",
    "banks by tradition. No membership, no dues, and nobody checks",
    "who you are.",
    "",
    "They ran the FREE KEVIN campaign for years and printed the",
    "stickers. See MITNICK.NFO.",
    "",
    "NOTE FOR THE FILE: they have been arguing this exact case",
    "since before this board had a phone line.",
  ],
  "L0PHT.NFO": [
    "L0PHT HEAVY INDUSTRIES",
    "======================",
    "",
    "A group in Boston, formed around 1992, working out of rented",
    "loft space full of secondhand hardware. Everybody used a",
    "handle. Nobody used a surname.",
    "",
    "What made them different from most of this directory: they",
    "were not breaking into anything. They were taking commercial",
    "products apart, finding what was wrong with them, and saying",
    "so in public, which at the time was considered outrageous.",
    "",
    "SYSOP NOTE, ADDED LATER: in 1998 seven of them sat in front of",
    "a United States Senate committee, testified under their",
    "handles, and told the senators they could take the internet",
    "down in half an hour. Nobody in the room disputed it.",
    "",
    "They were later absorbed into a real company, and the ones who",
    "wanted to went and did the same work with a business card.",
    "",
    "NOTE FOR THE FILE: this is the route out that did not exist",
    "yet in 1995. There was no job at the end of this for anybody",
    "on this board.",
  ],
  "SATAN.NFO": [
    "THE TOOL THAT WAS GOING TO END THE WORLD",
    "========================================",
    "",
    "5 April 1995. Six months ago.",
    "",
    "Dan Farmer and Wietse Venema released a program that scans a",
    "network and reports the known holes in it. They gave it away",
    "to everybody at once, on the reasoning that the people",
    "attacking your systems already had tools like it and the",
    "people defending them did not.",
    "",
    "The press spent a fortnight predicting the collapse of the",
    "internet. Advisories were issued. Administrators were told to",
    "brace.",
    "",
    "Nothing happened. The network is still here. The holes it",
    "found were holes that were already there, which was the entire",
    "argument.",
    "",
    "Farmer was working at a large computer company at the time and",
    "did not stay working there.",
    "",
    "NOTE FOR THE FILE: publishing a tool is not the same act as",
    "using one, and 1995 has not settled that argument. Neither has",
    "any year since.",
  ],
};
